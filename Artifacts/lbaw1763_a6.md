...
To this end, the following sections provide detailed insight into the inner workins of the project's database. The first section depicts the expected workload on the system, the second section specifies and explains the proposed indices to the database, and the third section comprises the database's triggers.
