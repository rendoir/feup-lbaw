...
* R312: Get answer's details ```/questions/{id}/answers/{id}```
* R313: Add a new answer - Form ```/questions/{id}/answers/create```
* R314: Add a new answer - Action ```/questions/{id}/answers```
* R315: Edit an answer - Form ```/questions/{id}/answers/{id}/edit```
* R316: Edit an answer - Action ```/questions/{id}/answers/{id}```
* R317: Delete an answer - Action ```/questions/{id}/answers/{id}```
...
JSON response containing a list of answers and their contents.
