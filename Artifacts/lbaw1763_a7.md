...
#### R318: Add a new comment to a question API

|                          |                          |
|--------------------------|--------------------------|
| URL | ```/api/questions/{id}/comments``` |
| Description | This web resource adds a new comment to a question. |
| Method | POST |
...
| | 400 Bad Request - Error. Error message is specified via HTTP header. |
| Permissions | USR |
