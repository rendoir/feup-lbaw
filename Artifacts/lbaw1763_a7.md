...
* [R321: Get answer's comments](#R321:-Get-answer's-comments) ```/questions/{id}/answers/{answer_id}/comments```
...
| Response body | [JSON03](#json03-comment) |
...
| | +comment_id: integer (Comment id) |
| Response body | [JSON04](#json04-comments-comment) |
| UI | Click on the 'Add Comment' button, in the Answer bottom section.Available in [UI03](https://jflcarvalho.github.io/lbaw1763/question(logged).html) |
| Permissions | PUB, USR |
...
| Response body | [JSON03](#json03-comment) |
| UI | Click on the 'Add Comment' button, in the answer's comments section, after writing the comment. Available in [UI03](https://jflcarvalho.github.io/lbaw1763/question(logged).html) |
| Permissions | USR |
...
| | +comment: integer (Comment id) |
| Response body | [JSON03](#json03-comment) |
| UI | Click on the pencil icon, in the bottom left corner of the comment, in the answer's comments section. Available in [UI03](https://jflcarvalho.github.io/lbaw1763/question(logged).html) |
| Permissions | OWN, MOD |
...
| UI | Search box present in [UI01](https://jflcarvalho.github.io/lbaw1763/tags.html) |
...
| Description | Web resource that shows the questions associated to a category. |
| Method | GET |
| UI | [UI01](https://jflcarvalho.github.io/lbaw1763/) |
...
JSON response containing a answer's details and contents, as well as its previous versions, in order to show if it was edited and by whom.
