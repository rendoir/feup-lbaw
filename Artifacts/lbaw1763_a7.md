...
#### R318: Add a new comment to a question - Form

|                          |                          |
|--------------------------|--------------------------|
| URL | ```/questions/{id}/comments/create``` |
| Description | Page with a form to create a new comment. |
| Method | GET |
| UI | Click on button 'Add Comment' present in every comment section available in [UI18](https://jflcarvalho.github.io/lbaw1763/question(logged).html) |
| SUBMIT | [R319](#r308-add-a-new-comment-to-a-question---action) |
| Permissions | USR |

#### R319: Add a new comment to a question - Action
|                          |                          |
|--------------------------|--------------------------|
| URL | ```/questions/{id}/comments``` |
| Description | Web resource that creates a new comment based on the input received. Redirects to the question page. |
| Method | POST |
| Request Body | +content: string (The comment's contents) |
| | +author: integer (The comment author's id) |
| Redirects | [R306](#r306-get-questions-details)|
| Permissions | USR, OWN _Why OWN tb?_|
