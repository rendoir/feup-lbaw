...
Figure 3.c: While logged in, to add a comment (to a question, for example) you should click the button that shows the comments to that message (1), then you'll be shown a text area where you can write your comment (2) and finaly you can submit it by clicking on the "Add comment" button.

![Logout.](StoryBoard/Logout/StoryBoard.png)
Figure 3.d: To log out you have to click on your profile thumbnail (1), then you'll be shown a dropdown where you'll have to click on the "Log out" option.

![Profile.](StoryBoard/Profile/StoryBoard.png)
Figure 3.e: To check your profile click on your profile thumbnail (1), then you'll be shown a dropdown where you'll have to click on the  "Profile" option.
