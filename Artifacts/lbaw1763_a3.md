...
To this end, the following sections provide detailed insight into the project, featuring storyboards
...
Figure 3.a: While logged in, to answer a question you must write your answer on the text area (1) and then submit your answer by clicking on the "Post answer" button (2).

![Ask Question.](StoryBoard/Ask_question/StoryBoard.png)
![Ask Question 2.](StoryBoard/Ask_question/StoryBoard(2).png)
Figure 3.b: While logged in, to ask a question you must enter your question title (1) - which can later be modified -, click the "Ask!" button on (2) the landing page and you'll be redirected to the "ask question page". There you'll write your question on the text area (3), the related tags (4) and then submit it by clicking on the "Post your question" button (5).

![Add a comment.](StoryBoard/Comment/StoryBoard.png)
Figure 3.c: While logged in, to add a comment (to a question, for example) you should click the button that shows the comments to that message (1), then you'll be shown a text area where you can write your comment (2) and finally you can submit it by clicking on the "Add comment" button (3).

![Logout.](StoryBoard/Logout/StoryBoard.png)
Figure 3.d: To log out you have to click on your profile thumbnail (1), then you'll be shown a dropdown where you'll have to click on the "Log out" option (2).

![Profile.](StoryBoard/Profile/StoryBoard.png)
Figure 3.e: To check your profile click on your profile thumbnail (1), then you'll be shown a dropdown where you'll have to click on the  "Profile" option (2).

![Sign in.](StoryBoard/Sign_in/StoryBoard.png)
Figure 3.f: While visiting the website, to sign in you can click the "Sign in" button (1), then you'll be shown a dropdown where you'll have to fill your credentials (2) and finally enter them by clicking "Sign in" (3).

![Sign up.](StoryBoard/Sign_up/StoryBoard.png)
![Sign up 2.](StoryBoard/Sign_up/StoryBoard(2).png)
Figure 3.g: While visiting the website, to sign up you can click the "Sign up" button (1), which will redirect you to the "Sign up page" where you'll enter your personal credentials (2), accept our terms and conditions by checking the checkbox (3) and finally clicking "Sign up for SegFault" (4).
...
![Question page, owner view.](screenshots/question-own.png)
Figure 6.e: [Question page, owner view](https://jflcarvalho.github.io/lbaw1763/question-own.html).

<img src="screenshots/question-own_mobile.png" alt="Question page, owner view." style="width: 180px;"/>
Figure 6.f: Question page, owner view, on mobile.
