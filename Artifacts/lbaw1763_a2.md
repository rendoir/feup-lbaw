...
|:---:|:-------:|:----:|:-------------------------------------------:|:-------:|
| US01 | Content | High     | As a User, I want to consult Questions, their Answers and their Comments, so that I can read and learn with them. | 40 |
...
|    US212   |     Report a Message     | Low | As a Member, I want to report a Message, so that the website remains without inadequate content. | 6 |
