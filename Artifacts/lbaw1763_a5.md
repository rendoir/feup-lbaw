...
| R12                | Moderator(__ID__ → User)                                                                              |
| R13                | Notification(__ID__, description NN, date NN, read NN, userID → User)                                 |
| R14                | CommentableNotification(__ID__ → Notification, commentableID → Commentable NN)                        |
| R15                | BadgeNotification(__ID__ → Notification, badgeID → Badge NN)                                          |
| R16                | BadgeAttainment(__userID__ →User, __badgeID__ → Badge, attainmentDate NN)                             |
| R17                | Badge(__ID__, description NN)                                                                         |
| R18                | ModeratorBadge(__ID__ → Badge)                                                                        |
| R19                | TrustedBadge(__ID__ → Badge)                                                                          |
