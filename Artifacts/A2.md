...
| Identifier | Name | Priority | Description |
|:----------:|:------------------------:|:--------:|:------------------------------------------------------------------------------------------------------------------------:|
|    US31   |     Select correct Answer     |  Medium  | As a Owner, I want to select a correct Answer to my own Question, so that other Users know what is the correct Answer without having to read all of the other answers.
|    US32   |      Delete an Answer     |  Medium  | As a Owner, I want to delete my own Answer, so that the related Question does not have inappropriate Answers. |
|    US33   |     Delete a Comment     |  Medium  | As a Owner, I want to delete my own Comment, so that the related Question/ Answer does not have inappropriate comments.                            |
|    US34   |      Edit a Question     |  Medium  | As a Owner, I want to edit my own Questions, so that I keep them updated and adequate.                                                                             |
|    US35   |       Edit an Answer      |  Medium  | As a Owner, I want to edit my own Answers, so that I keep them updated and adequate.                                                                               |
|    US36   |      Edit a Comment      |  Medium  | As a Owner, I want to edit my own Comments, so that I keep them updated and adequate. |
